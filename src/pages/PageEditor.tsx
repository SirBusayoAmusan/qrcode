...
export const PageEditor: React.FC = () => {
  ...
  const { user, pages, activeChannel, createPage, updatePage, profile, trialActive } = useApp();
  ...
  const [productLinks, setProductLinks] = useState<ProductLink[]>(() => {
    ...
    return [{ id: 'prod-1', title: 'My Digital Resource / Course', url: '' }];
  });
  ...
  const handleDownloadIntercept = (actualDownloadFn: () => void) => {
    if (!user || !isPro) {
      setPendingDownloadAction(() => actualDownloadFn);
      setShowPaywallModal(true);
    } else {
      actualDownloadFn();
    }
    ...
    <div className="space-y-6 animate-fade-in pb-12 w-full max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <span className="text-[10px] uppercase font-bold tracking-widest text-violet-600 block truncate">
              {isEditing ? 'Edit QR Tapframe' : 'Tapframe Creator Studio'}
            </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          <form onSubmit={handleSaveOrPublish} className="space-y-6">
            ...
            <div className="p-5 sm:p-6 rounded-3xl bg-white border border-slate-200/90 space-y-4 sm:space-y-5 shadow-xs">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Free Strategy Pack Below"
                    ...
                    <div key={link.id || idx} className="p-4 rounded-2xl bg-white border border-slate-200 space-y-2.5 relative shadow-xs">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-slate-500 mt-1 pl-1">
                          Accepts <code>https://...</code>, <code>www.domain.com</code>, or <code>domain.com</code> (auto-prefixed with https://).
                        </p>
                      </div>
                    </div>
                  ))}
              ...
              <div className="pt-2">
                ...
                >
                  <Save className="w-4 h-4" />
                  <span>{saving ? 'Publishing Tapframe...' : 'Save & Download 4K QR Tapframe'}</span>
                </button>
              </div>
            </div>
          </form>
            ...
            {previewTab === 'mobile' ? (
              ...
              <div className="w-full">
                <QRCodeDisplay 
                  ...
                  onDownloadIntercept={handleDownloadIntercept}
                />
              </div>
            )}
          </div>
